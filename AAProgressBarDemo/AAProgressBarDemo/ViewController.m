...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSArray *progressBarType = @[@"linear",@"circular",];
    vc.progressBarType = progressBarType[indexPath.row];
